...
// dp - ESCC radar interceptor: radar stays alive, we relay its AEB state through SCC12
...
void hyundai_common_init(uint16_t param) {
  ...
  const uint16_t HYUNDAI_PARAM_ESCC = 1024;  // dp
  ...
  hyundai_escc = GET_FLAG(param, HYUNDAI_PARAM_ESCC);  // dp
