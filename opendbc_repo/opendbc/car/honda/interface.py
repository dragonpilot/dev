...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    if ret.flags & HondaFlags.BOSCH:
      ...
      # upstream file is one hunk: dropping the feature drops the import with it, and any
      # other honda feature that patches this function never conflicts on a shared import.
      from opendbc.car.dp_params import DP_CAR
      if DP_CAR["dp_honda_nidec_stock_long"]:
